...
def main ():
    ...
    #Zombies
    Zombie("Mommy", "A ZOMBIE WHO LIKES BRAINSSSSS", 10).register(q,100).materialize(scr,LEVEL_WIDTH-20,LEVEL_HEIGHT-30)
    Zombie("Daddy", "GIVE ME YOUR FACE", 50).register(q,10).materialize(scr,LEVEL_WIDTH-21,LEVEL_HEIGHT-30)
